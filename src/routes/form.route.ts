...
import { checkRole, validateRequest, validateDynamicSchema } from '../middleware/index';
...
// --- ADMIN ROUTES ---
formRoute.post('/forms', checkRole(UserRole.ADMIN), validateRequest(createFormSchema), formController.create);
...
// --- USER ROUTES ---
formRoute.get('/forms/:slug', validateRequest(getFormSchema), formController.getOne);
